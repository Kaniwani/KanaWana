...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.stripOkurigana = exports.toRomaji = exports.toKana = exports.toKatakana = exports.toHiragana = exports.isKanji = exports.isRomajiKana = exports.isRomaji = exports.isKanjiKana = exports.isKana = exports.isKatakana = exports.isHiragana = exports.romajiToKana = exports.romajiToHiragana = exports.hiraganaToKatakana = exports.katakanaToHiragana = exports.unbind = exports.bind = undefined;
	...
	var _stripOkurigana = __webpack_require__(31);
	...
	exports.katakanaToHiragana = _katakanaToHiragana2.default;
	exports.hiraganaToKatakana = _hiraganaToKatakana2.default;
	exports.romajiToHiragana = _romajiToHiragana2.default;
	exports.romajiToKana = _romajiToKana2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isCharLongDash = __webpack_require__(5);
	
	var _isCharLongDash2 = _interopRequireDefault(_isCharLongDash);
	
	var _isCharSlashDot = __webpack_require__(6);
	
	var _isCharSlashDot2 = _interopRequireDefault(_isCharSlashDot);
	
	var _isCharKatakana = __webpack_require__(7);
	...
	function katakanaToHiragana(kata) {
	  ...
	  for (var index = 0; index < iterable.length; index += 1) {
	    ...
	    var _ref = [(0, _isCharSlashDot2.default)(kataChar), (0, _isCharLongDash2.default)(kataChar)],
	        slashDot = _ref[0],
	        longDash = _ref[1];
	    ...
	    if (slashDot || longDash && index < 1) {
	      ...
	      var romaji = (0, _hiraganaToKatakana2.default)(previousKana).slice(-1);
	      hira.push(_constants.LONG_VOWELS[romaji]);
	    } else if ((0, _isCharKatakana2.default)(kataChar)) {
	      // Shift charcode.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isCharHiragana = __webpack_require__(9);
	...
	function hiraganaToKatakana(hira) {
	  ...
	  hira.split('').forEach(function (hiraChar) {
	    // Short circuit to avoid incorrect codeshift for 'ー' and '・'
	    if ((0, _isCharLongDash2.default)(hiraChar) || (0, _isCharSlashDot2.default)(hiraChar)) {
	      kata.push(hiraChar);
	    } else if ((0, _isCharHiragana2.default)(hiraChar)) {
	      // Shift charcode.
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @return {String} converted text
	 */
	function romajiToHiragana(roma) {
	  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
	
	  return (0, _romajiToKana2.default)(roma, options, true);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function romajiToKana(roma) {
	  ...
	  while (cursor < len) {
	    ...
	    while (chunkSize > 0) {
	      chunk = (0, _getChunk2.default)(roma, cursor, cursor + chunkSize);
	    ...
	    if (!!config.IMEMode && chunkLC.charAt(0) === 'n') {
	      if (roma.charAt(cursor + 1).toLowerCase() === 'y' && (0, _isCharVowel2.default)(roma.charAt(cursor + 2)) === false || cursor === len - 1 || (0, _isKana2.default)(roma.charAt(cursor + 1))) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isCharKana = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function isRomaji(input) {
	  return [].concat(_toConsumableArray(input)).every(function (char) {
	    return !(0, _isHiragana2.default)(char) && !(0, _isKatakana2.default)(char) && !(0, _isKanji2.default)(char);
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isCharKanji = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function toKana(input, options) {
	  return (0, _romajiToKana2.default)(input, options);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hiraganaToRomaji = __webpack_require__(30);
	
	var _hiraganaToRomaji2 = _interopRequireDefault(_hiraganaToRomaji);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function toRomaji(input, options) {
	  return (0, _hiraganaToRomaji2.default)(input, options);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = hiraganaToRomaji;
	...
	function hiraganaToRomaji(hira) {
	  ...
	  while (cursor < len) {
	    ...
	    while (chunkSize > 0) {
	      chunk = (0, _getChunk2.default)(hira, cursor, cursor + chunkSize);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function stripOkurigana(input) {
	  ...
	  if (!(0, _isKanjiKana2.default)(input) || (0, _isKana2.default)(input)) return input;
	  var chars = [].concat(_toConsumableArray(input));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isCharEnglishPunctuation = __webpack_require__(33);
	
	var _isCharEnglishPunctuation2 = _interopRequireDefault(_isCharEnglishPunctuation);
	
	var _isCharJapanesePunctuation = __webpack_require__(34);
